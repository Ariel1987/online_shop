...
import onlineshop.entities.implementation.DefaultProduct;
import onlineshop.services.ProductManageService;

public class DefaultProductManagementService implements ProductManageService {
	...
	public DefaultProductManagementService() {
		
	}
	
	public static ProductManageService getInstance() {
		if (instance == null) {
